...
public class minesweeper_backup extends ApplicationAdapter {
	...
	public void create () {
		...
		Gdx.graphics.setDisplayMode(360, 640, false);
		...
		view = new View(board);
		Globals.cellSize = 8*((Gdx.graphics.getWidth()-12*Globals.cellSize/16)/Globals.BoardWidth/8);
	}
